...
<head>
  ...
  <title>Productos para Gatos | WildPet</title>
...
<header class="header">
  <div class="header-inner">
    ...
    <nav class="nav">
      ...
      <a class="active" href="Gatos.php">Gatos</a>
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  const keywordMap = {
    "Todos": [],
    "Comida": ["comida", "alimento", "pienso", "snack", "salmon", "salmón"],
    "Accesorios": ["collar", "correa", "arnes", "arnés", "accesorio", "placa", "cama", "rascador"],
    "Higiene": ["higiene", "cepillo", "champu", "champú", "limpieza", "arena", "toallita"],
    "Juguetes": ["juguete", "pelota", "raton", "ratón", "mordedor", "cascabel"]
  };
