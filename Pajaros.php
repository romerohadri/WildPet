...
<head>
  ...
  <title>Productos para Pájaros | WildPet</title>
...
<header class="header">
  <div class="header-inner">
    ...
    <nav class="nav">
      ...
      <a class="active" href="Pajaros.php">Pájaros</a>
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  const keywordMap = {
    "Todos": [],
    "Comida": ["comida", "alimento", "semilla", "mix", "barrita"],
    "Accesorios": ["accesorio", "jaula", "comedero", "bebedero", "percha"],
    "Higiene": ["higiene", "limpieza", "desinfectante"],
    "Juguetes": ["juguete", "campana", "columpio", "espejo"]
  };
