...
<head>
  ...
  <title>Productos para Peces | WildPet</title>
...
<header class="header">
  <div class="header-inner">
    ...
    <nav class="nav">
      ...
      <a class="active" href="Peces.php">Peces</a>
    </nav>
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  const keywordMap = {
    "Todos": [],
    "Comida": ["comida", "alimento", "escamas", "granulado", "pellet"],
    "Accesorios": ["accesorio", "acuario", "filtro", "decoracion", "decoración", "termometro", "termómetro"],
    "Higiene": ["higiene", "limpieza", "acondicionador", "antialgas"],
    "Juguetes": ["juguete", "cueva", "tubo"]
  };
